import { Element } from "./myLibs/Element.js";
...
async function main() {
	...
	await env.addObject(new Element("Cube", './resources/models/cube.obj', {x: 0, y: 0, z: 0}, {x: 0, y: 0, z: 0.5}, './resources/models/cubeTextured.mtl'));
	await env.addObject(new Element("Cube", './resources/models/cube.obj', {x: 0, y: 0, z: 2}));
