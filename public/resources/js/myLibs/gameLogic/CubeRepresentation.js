        ...
        if (borders == 3) {
            ...
            if (x == this.size - 1) {
                neighbours.push({
                    ...
                    value: this.getCellValue(x - 1, y, z)
                });
                ...
                if (y == this.size - 1) {
                    neighbours.push({
                        ...
                        value: this.getCellValue(x, y - 1, z)
                    });
                    neighbours.push({
                        cell: {
                            x: x - 1,
                        ...
                        value: this.getCellValue(x - 1, y - 1, z)
                    });
                    ...
                    if (z == this.size - 1) {
                        neighbours.push({
                            ...
                            value: this.getCellValue(x, y - 1, z - 1)
                        });
                        neighbours.push({
                            cell: {
                                x: x,
                            ...
                            value: this.getCellValue(x, y, z - 1)
                        });
                        neighbours.push({
                            cell: {
                                x: x - 1,
                            ...
                            value: this.getCellValue(x - 1, y, z - 1)
                        });
                    } else if (z == 0) {
                        neighbours.push({
                            cell: {
